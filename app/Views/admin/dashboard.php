...
<div class="text-sm font-medium lg:text-base">
    <a href="#" class="p-3 mt-3 flex items-center rounded-md px-4 bg-purple-600">
        <h1 class="font-semibold text-white tracking-wide ">Dashboard</h1>
    </a>
    <a href="posting/postingan" class="p-3 mt-3 flex items-center rounded-md px-4 bg-white">
        <h1 class=" text-stone-900 tracking-wide">Post</h1>
    </a>
...
<section class="mx-8 mt-16 mb-10 md:flex md:justify-between md:mx-16 lg:mt-8 lg:ml-8 lg:mr-24">
    <div class=" grid grid-cols-2 gap-2 md:flex">
        <div class="bg-purple-300 py-3 px-4 text-center text-stone-900 rounded-lg shadow-xl md:w-36 lg:w-44 lg:py-4 lg:text-lg">
            <h1 class="font-bold">Done</h1>
            <h1 class="font-medium">0</h1>
        </div>
        <div class="bg-white border py-3 px-4 text-center text-stone-900 rounded-lg shadow-xl md:w-36 lg:w-44 lg:py-4 lg:text-lg">
            <h1 class="font-bold">Waiting</h1>
    ...
    <div class="md:flex md:items-end">
        <a href="posting/form" class="flex bg-purple-600 text-white gap-2 justify-center py-2 rounded-lg mt-4 items-center md:mt-0 md:px-3 md:h-10 md:text-sm">
                    ...
                    <tr class="odd:bg-white even:bg-slate-50">
                        ...
                        <td class="p-3">
                            <div class="flex justify-center gap-1">
                                <a href="<?= base_url('posting/prosesEdit?aksi=add&id_posting=' . $row->id_posting); ?>"><i class="bi bi-pencil-square p-2 px-3 bg-blue-400 text-white rounded-lg mr-4"></i></a>
